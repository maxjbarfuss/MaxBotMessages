...
class IntStamped : public ::google::protobuf::Message {
 public:
  ...
  inline const ::MaxBotMessages::Int& int_() const;
  inline ::MaxBotMessages::Int* mutable_int_();
  inline ::MaxBotMessages::Int* release_int_();
  inline void set_allocated_int_(::MaxBotMessages::Int* int_);
...
class DoubleStamped : public ::google::protobuf::Message {
 public:
  ...
  inline const ::MaxBotMessages::Double& double_() const;
  inline ::MaxBotMessages::Double* mutable_double_();
  inline ::MaxBotMessages::Double* release_double_();
  inline void set_allocated_double_(::MaxBotMessages::Double* double_);
...
class StringStamped : public ::google::protobuf::Message {
 public:
  ...
  inline const ::MaxBotMessages::String& string() const;
  inline ::MaxBotMessages::String* mutable_string();
  inline ::MaxBotMessages::String* release_string();
  inline void set_allocated_string(::MaxBotMessages::String* string);
...
inline ::MaxBotMessages::Int* IntStamped::mutable_int_() {
  set_has_int_();
  if (int__ == NULL) int__ = new ::MaxBotMessages::Int;
...
inline ::MaxBotMessages::Double* DoubleStamped::mutable_double_() {
  set_has_double_();
  if (double__ == NULL) double__ = new ::MaxBotMessages::Double;
...
inline ::MaxBotMessages::String* StringStamped::mutable_string() {
  set_has_string();
  if (string_ == NULL) string_ = new ::MaxBotMessages::String;
